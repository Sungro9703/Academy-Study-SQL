...
-- Copyright   : Copyright �뜝占� 2017 by www.oracletutorial.com. All Rights Reserved.
-- Notice      : Use this sample database for the educational purpose only.
--               Credit the site oracletutorial.com explitly in your materials that
--               use this sample database.
--------------------------------------------------------------------------------------

drop table contacts CASCADE CONSTRAINT;
drop table contries CASCADE CONSTRAINT;
drop table customers CASCADE CONSTRAINT;
drop table employees CASCADE CONSTRAINT;
drop table inventories CASCADE CONSTRAINT;
drop table locations CASCADE CONSTRAINT;
drop table orders CASCADE CONSTRAINT;
drop table orders_items CASCADE CONSTRAINT;
drop table products CASCADE CONSTRAINT;
drop table product_categories CASCADE CONSTRAINT;
...
CREATE TABLE countries
  (
    ...
    CONSTRAINT fk_countries_regions FOREIGN KEY( region_id )
      ...
      ON DELETE CASCADE			-- regions �뀒�씠釉붿쓽 �뒠�뵆�룄 �븿猿� �궘�젣
  );
...
CREATE TABLE orders
  (
    ...
    CONSTRAINT fk_orders_employees 
      ...
      REFERENCES employees( employee_id ) 
      ON DELETE SET NULL		-- employees�쓽 employee_id �냽�꽦 媛믪쓣 NULL濡� 蹂�寃�
  );
-- order items
